...
class NativeNotificationService {
  ...
  static const String _checkNotificationPermissionMethod = 'checkNotificationPermission';
  ...
  static Future<bool> hasNotificationPermission() async {
    try {
      final result = await _channel.invokeMethod(_checkNotificationPermissionMethod);
      return result as bool;
