...
@Deprecated('Replaced by SystemSettingsService + AlarmSettingsWatcher. Will be removed after v1.2.0-2.')
class ExactAlarmPermissionService {
  ExactAlarmPermissionService._();
  static final instance = ExactAlarmPermissionService._();
  Never _deprecated() => throw UnimplementedError('ExactAlarmPermissionService removed. Use SystemSettingsService.');
