...
class FilterChips extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final chipBorder = BorderSide(color: theme.colorScheme.onSurface.withOpacity(0.06));
            ...
            child: Padding(
              ...
              child: Row(
                ...
                PopupMenuButton<String>(
                  ...
                  onSelected: (value) => ref.read(selectedPriorityProvider.notifier).state = value,
                  ...
                  child: Chip(
                    ...
                    avatar: Icon(Icons.flag_outlined, size: 14, color: theme.colorScheme.onSurfaceVariant.withOpacity(0.8)),
                ...
                PopupMenuButton<String>(
                  initialValue: sortBy,
                  onSelected: (value) => ref.read(sortByProvider.notifier).state = value,
                  itemBuilder: (context) => const [
                  ...
                  child: Chip(
                    ...
                    avatar: Icon(Icons.sort, size: 14, color: theme.colorScheme.onSurfaceVariant.withOpacity(0.8)),
                    backgroundColor: chipBg,
                    shape: StadiumBorder(side: chipBorder),
                    labelStyle: theme.textTheme.bodyMedium?.copyWith(
                      fontWeight: FontWeight.w400,
                ...
                FilterChip(
                  ...
                  onSelected: (selected) => ref.read(showCompletedProvider.notifier).state = selected,
                  avatar: Icon(
                    showCompleted ? Icons.visibility : Icons.visibility_off,
                    size: 14,
                    color: showCompleted ? chipSelectedLabelColor : theme.colorScheme.onSurfaceVariant.withOpacity(0.8),
                  ),
                  backgroundColor: chipBg,
                  ...
                  labelStyle: theme.textTheme.bodyMedium?.copyWith(
                    fontWeight: FontWeight.w400,
                    fontSize: 13.0,
                    color: showCompleted ? chipSelectedLabelColor : chipLabelColor,
                  ),
                ),
                ],
              ), // Row
