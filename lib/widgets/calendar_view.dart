...
class _CalendarViewState extends ConsumerState<CalendarView> {
  ...
  List<Todo> _getTasksForDay(DateTime day) {
    return widget.tasks.where((task) {
      ...
      if (task.startDate != null) {
        ...
        final endDate = DateTime(task.dueDate!.year, task.dueDate!.month, task.dueDate!.day);
  ...
  Widget build(BuildContext context) {
    ...
    final selectedDayTasks = _selectedDay != null ? _getTasksForDay(_selectedDay!) : <Todo>[];
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            eventLoader: (day) => _getTasksGroupedByDay()[DateTime(day.year, day.month, day.day)] ?? [],
