      ...
      body: ListView(
        children: [
          ...
          ListTile(
            ...
            subtitle: Text(
              '${prefs.lineHeightMultiplier.toStringAsFixed(1)}×',
            ),
            trailing: const Icon(Icons.chevron_right),
  ...
  void _showFontPicker(BuildContext context, WidgetRef ref) {
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => ListView(
        shrinkWrap: true,
        children: [
          _fontOption(ctx, controller, currentFont, 'default',
              'Default (app font)', 'Same as the global app font',
              Icons.font_download_outlined),
          _fontOption(ctx, controller, currentFont, 'inter', 'Inter',
              'Modern, geometric UI typeface', Icons.text_fields),
          _fontOption(ctx, controller, currentFont, 'roboto', 'Roboto',
              'Material default', Icons.android),
          _fontOption(ctx, controller, currentFont, 'lexend', 'Lexend',
              'Enhanced readability', Icons.visibility),
          _fontOption(ctx, controller, currentFont, 'opensans', 'Open Sans',
              'Clean & neutral', Icons.font_download),
          _fontOption(ctx, controller, currentFont, 'jetbrains',
              'JetBrains Mono', 'Code & technical', Icons.code),
          _fontOption(ctx, controller, currentFont, 'monospace', 'Monospace',
              'System monospace font', Icons.space_bar),
